...
const Footer = () => {
  return (
    <footer className="mt-5 bg-neutral text-neutral-content flex flex-col md:flex-row items-center justify-between px-6 py-4  shadow-inner">
      ...
      <div className="flex gap-4 mt-3 md:mt-0">
        ...
        >
          <svg
            ...
            height="24"
            viewBox="0 0 24 24"
            className="fill-current text-[#f5e0d6] hover:text-[#c53d0e]"
          >
            <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 
              ...
              -1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 
